...
var FullCalendar = (function (exports) {
    ...
    */
    ...
    function renderInnerContent$4(innerProps) {
        return (createElement("div", { className: "fc-event-main-frame" },
            ...
            createElement("div", { className: "fc-event-title-container" },
                createElement("div", { className: "fc-event-title fc-sticky fs-5" }, innerProps.event.title || createElement(Fragment, null, "\u00A0")),
                createElement("div", { className: "fc-event-title fc-sticky fs-5" }, innerProps.event.priority || createElement(Fragment, null, "\u00A0")),
                )));
    }
    ...
    function renderInnerContent$3(props) {
        ...
        return title, priority && (createElement("div", { className: "fc-event-title" }, props.event.title)) && (createElement("div", { className: "fc-event-title" }, props.event.priority));
    }
        ...
        Popover.prototype.render = function () {
            ...
            return createPortal(createElement("div", __assign({ className: classNames.join(' ') }, props.extraAttrs, { ref: this.handleRootEl }),
                createElement("div", { className: 'fc-popover-header ' + theme.getClass('popoverHeader') },
                    ...
                    createElement("span", { className: "fc-popover-title" }, props.priority),
    ...
    */
    ...
    function renderInnerContent$2(innerProps) {
        return (createElement(Fragment, null,
            ...
            createElement("div", { className: "fc-event-title" }, innerProps.event.priority || createElement(Fragment, null, "\u00A0"))
        ));
    }
    ...
    */
    ...
    function renderEventInnerContent(props) {
        ...
        return (createElement("a", __assign({}, anchorAttrs), event.title, createElement("a", __assign({}, anchorAttrs), event.priority)));
    }
