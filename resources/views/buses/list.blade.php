                        ...
                        <div class="table-responsive">
                            ...
                            <table id="kt_por_levantar_table" class="table table-row-bordered table-row-dashed gy-4 align-middle fw-bolder dataTable no-footer">
                                ...
                                <thead class="fs-7 text-gray-400 align-center text-uppercase">
                                    <tr>
                                        <th class="mw-40px sorting text-start sorting_asc" tabindex="0" rowspan="1" colspan="1" style="width: 0px;">{{ __('Licence Plate') }}</th>
                                        <th class="mw-40px sorting text-start" tabindex="0" rowspan="1" colspan="1" style="width: 0px;">{{ __('Brand') }}</th>
                                        <th class="mw-60px sorting text-start" tabindex="0" rowspan="1" colspan="1" style="width: 0px;">{{ __('Model') }}</th>
                                        <th class="mw-90px sorting text-start" tabindex="0" rowspan="1" colspan="1" style="width: 0px;">{{ __('Prod Year') }}</th>
                                        <th class="mw-200px sorting text-start" tabindex="0" rowspan="1" colspan="1" style="width: 0px;" aria-sort="descending">{{ __('Company') }}</th>
                                        <th class="mw-60px sorting text-start" tabindex="0" rowspan="1" colspan="1" style="width: 0px;">{{ __('State') }}</th>
                                        <th class="mw-30px sorting text-start" tabindex="0" rowspan="1" colspan="1" style="width: 0px;">{{ __('Fuel') }}</th>
                                        <th class="mw-50px text-center sorting" rowspan="1" colspan="1" aria-label="Details" style="width: 0px;">{{ __('Actions') }}</th>
