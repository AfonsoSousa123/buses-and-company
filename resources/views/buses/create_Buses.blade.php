          ...
          {{ csrf_field() }}
            ...
            <div class="row" style="margin-bottom:10px;">
              ...
              <div class="col-sm-6 blog-main">
                ...
                <input type="text" class="form-control" name="Matricula" placeholder="XX-XX-XX" required>
            ...
            <div class="row" style="margin-bottom:10px;">
              ...
              <div class="col-sm-6 blog-main">
                ...
                <input type="text" class="form-control" name="Ano_prod" placeholder="Máximo de 4 digitos">
            ...
            <div class="row" style="margin-bottom:20px;">
              ...
              <div class="col-sm-3 blog-main"style="margin-top:33px;">
                ...
                <div class="custom-file">
                  ...
                  <input type="hidden" name="Imagem" id="imagem-wrapper" />
          ...
          <span class="em" style="display: none;">
            ...
            <div class="row" style="margin-bottom:10px;">
              ...
              <div class="col-sm-4 blog-main">
                ...
                <label for="Carrocaria">Carrocaría</label>
  
                <input type="text" class="form-control" name="Carrocaria">
            ...
            <div class="row" style="margin-bottom:10px;">
              ...
              <div class="col-sm-4 blog-main">
                ...
                <input type="text" class="form-control" name="Comprimento" placeholder="Formato: metros,centímetros">
              ...
              <div class="col-sm-4 blog-main">
                ...
                <input type="text" class="form-control" name="Largura" placeholder="Formato: metros,centímetros">
              ...
              <div class="col-sm-4 blog-main">
                ...
                <input type="text" class="form-control" name="Altura" placeholder="Formato: metros,centímetros">
            ...
            <div class="row" style="margin-bottom:10px;">
              ...
              <div class="col-sm-6 blog-main">
                ...
                <input type="text" class="form-control" name="Dist_entre_eixos" placeholder="Formato: metros,centímetros">
              ...
              <div class="col-sm-6 blog-main">
                ...
                <input type="text" class="form-control" name="Peso_bruto" placeholder="Em quílos ou toneladas">
            ...
            <div class="row">
              ...
              <div class="col-md-12 blog-main">
                ...
                <textarea name="Descricao" cols="5" rows="10" class="form-control" placeholder="Escreva aqui a descrição/história do Autocarro..."></textarea>
