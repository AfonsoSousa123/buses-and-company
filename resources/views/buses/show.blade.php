                    ...
                    <div id="preamble" class="posts_show">
                        <div class="col-sm-12 blog-main">
                            ...
                            <ul class="list-group" id="table_b">
                                ...
                                <li class="list-group-item"><span class="list-buses">Matrícula:</span>
                                    <strong>{{ $bus->Matricula }}</strong></li>
                                <li class="list-group-item"><span class="list-buses">Marca:</span>
                                    <strong>{{ $bus->Marca }}</strong></li>
                                <li class="list-group-item"><span class="list-buses">Modelo:</span>
                                    <strong>{{ $bus->Modelo }}</strong></li>
                                <li class="list-group-item"><span class="list-buses">Ano de Produção:</span>
                                    <strong>{{ $bus->Ano_Producao }}</strong></li>
                                <li class="list-group-item"><span class="list-buses">Empresa:</span>
                                    <strong>{{ $bus->Empresa }}</strong></li>
