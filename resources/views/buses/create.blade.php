                        ...
                        >
                            ...
                            <div class="row row-cols-lg-2 g-10">
                                <div class="col-lg-6">
                                    <div class="fv-row mb-9">
                                        <!--begin::Label-->
                                        <label class="fs-6 fw-bold mb-2">{{ __('Old Licence Plate') }}</label>
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input
                                            type="text"
                                            class="form-control form-control-solid @error('old_licence_plate') is-invalid @enderror"
                                            name="old_licence_plate"
                                            id="old_licence_plate"
                                            value="{{ old('old_licence_plate') }}"
                                            placeholder="{{ __('__-__-__') }}"
                                        >
                                        <!--end::Input-->
                                        <div class="fv-plugins-message-container invalid-feedback"></div>
                                        @error('old_licence_plate')
                                        @foreach($errors->get('old_licence_plate') as $message)
                                            <div class="fv-plugins-message-container invalid-feedback">{{ $message }}</div>
                                        @endforeach
                                        @enderror
                                    </div>
                            ...
                            <div class="row row-cols-lg-2 g-10">
                                <div class="col-lg-6">
                                    <div class="fv-row mb-9">
                                        <!--begin::Label-->
                                        <label for="weight" class="fs-6 fw-bold mb-2">{{ __('Weight') }}</label>
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input
                                            type="text"
                                            ...
                                            id="weight"
                                            value="{{ old('weight') }}"
                                            placeholder="{{ __('Insert the weight here') }}"
                                        >
                                        <!--end::Input-->
                                        <div class="fv-plugins-message-container invalid-feedback"></div>
                                        @error('weight')
