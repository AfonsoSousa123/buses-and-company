                                    ...
                                    <div class="card-block">
                                        ...
                                        <form action="{{ route('comment-store', ['comment' => $post->id]) }}" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea id="comment" name="body" placeholder="O seu comentário..." class="form-control" required></textarea>
                ...
                <section id="work-visuals">
                    <ul>
                        ...
                        <li data-visual="florentina-logo-design">
                            <img style="width:700px;" class="img-thumbnail" src="{{ asset('images/project-detail-2.jpg') }}">&nbsp;
                        </li>
                    </ul>
                </section>
